...
async def callback(bot, update):
    ...
    if update.data == "home":
        ...
        await update.message.edit_text(
            text=HELP_TEXT, reply_markup=HELP_BUTTONS, disable_web_page_preview=True
        )
        ...
        await update.message.edit_text(
            text=RESET_TEXT, disable_web_page_preview=True, reply_markup=RESET_BUTTONS
        )
        ...
        await db.update_info(
            update.from_user.id, info, not await db.allow_info(chat_id, info)
        )
